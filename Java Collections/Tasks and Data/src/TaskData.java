...
public class TaskData {
    ...
    public static Set<Task> getTasks(String owner){
        ...
        for (String taskData : selectedList.split("\n")) {
            ...
            Task.Status status = (data.length <= 3) ? Task.Status.IN_PROGRESS :
                    Task.Status.valueOf(data[3].toUpperCase().replaceAll(" ",
                            "_"));
            Task.Priority priority = Task.Priority.valueOf(data[2].toUpperCase());
